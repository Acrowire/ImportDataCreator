...
{
    public class OSSupportSts : GenericModelBase<string>, IDataErrorInfo
    {
        ...
        {
            return ValidationHelper.Validate<OSSUpportStsValidator, OSSupportSts>(this);
        }

        #endregion
    }

    public class OSSUpportStsValidator : AbstractValidator<OSSupportSts>
    {
        public OSSUpportStsValidator()
        {
